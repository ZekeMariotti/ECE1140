...
class MainWindowR(QMainWindow):
    ...
    def BrokenRailSetup(self):
            ...
            for k in range(51,77):
                if WaysideControllerRed2.brokenRail[k] == True:
                    BrokenRail.setItem(i,j,QTableWidgetItem("ERROR"))
                else:
                    BrokenRail.setItem(i,j,QTableWidgetItem(" "))
                j=j+1
                if j>9:
                 j=0
                 i=i+1
    ...
    def Switch1OutSetup(self):
          ...
          if WaysideControllerRed.switches[1]==True:
    ...
    def updateVisualElements(self,active):
          ...
          if (self.Switch2Out.text() == "15 to 16" and WaysideControllerRed2.switches[2] == False) or (self.Switch2Out.text() == "1 to 16" and WaysideControllerRed2.switches[2] == True):
            TkMWCSignals.switchStateSignal.emit(int(WaysideControllerRed2.switches[2]), 0, 15)
          if (self.Switch3Out.text() == "27 to 28" and WaysideControllerRed2.switches[3] == False) or (self.Switch3Out.text() == "27 to 76" and WaysideControllerRed2.switches[3] == True):
            TkMWCSignals.switchStateSignal.emit(int(WaysideControllerRed2.switches[3]), 0, 26)
          if (self.Switch4Out.text() == "32 to 33" and WaysideControllerRed2.switches[4] == False) or (self.Switch4Out.text() == "33 to 72" and WaysideControllerRed2.switches[4] == True):
            TkMWCSignals.switchStateSignal.emit(int(WaysideControllerRed2.switches[4]), 0, 32)
          if (self.Switch5Out.text() == "38 to 39" and WaysideControllerRed2.switches[5] == False) or (self.Switch5Out.text() == "38 to 71" and WaysideControllerRed2.switches[5] == True):
            TkMWCSignals.switchStateSignal.emit(int(WaysideControllerRed2.switches[5]), 0, 37)
          if (self.Switch6Out.text() == "43 to 44" and WaysideControllerRed2.switches[6] == False) or (self.Switch6Out.text() == "44 to 67" and WaysideControllerRed2.switches[6] == True):
            TkMWCSignals.switchStateSignal.emit(int(WaysideControllerRed2.switches[6]), 0, 43)
          if (self.Switch7Out.text() == "52 to 53" and WaysideControllerRed2.switches[7] == False)  or (self.Switch7Out.text() == "52 to 66" and WaysideControllerRed2.switches[7] == True):
