...
WaysideControllerRed2.setdictionarysizes(51,77)
...
class MainWindowR(QMainWindow):
    ...
    def CommandedSpeedSetup(self):
            ...
            j=1
            for k in range(1,51):
                value=WaysideControllerRed.commandedSpeed[k]
    ...
    def AuthoritySetup(self):
            ...
            j=1
            for k in range(1,51):
                value=WaysideControllerRed.authority[k]
    ...
    def SignalLightSetup(self):
            ...
            j=1
            for k in range(1,51):
                if WaysideControllerRed.signalLights[k]==True:
                     value="G"
                else:
                     value="R"
    ...
    def updateVisualElements(self,active):
          ...
          if WaysideControllerRed.commandedSpeed!=WaysideControllerRed.suggestedSpeed:
            WaysideControllerRed.setCommandedSpeed()
...
#self.Authority
          ...
          for k in range(1,51):
                ...
                if active and value != float(self.CommandedSpeed.item(i,j).text()):
                  TkMWCSignals.commandedSpeedSignal.emit(k, float(value), 0)
